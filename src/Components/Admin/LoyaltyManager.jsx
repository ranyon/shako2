                            ...
                            <tr key={voucher.id}>
                                <td className="px-4 py-3 align-middle">
                                    <div className="d-flex align-items-center gap-2">
                                        <Badge bg="secondary" className="fs-6 py-2 px-3 text-monospace" style={{ letterSpacing: '2px' }}>
                                            {voucher.code}
                                        </Badge>
                                        <Button variant="link" size="sm" className="text-muted p-0 ms-2" onClick={() => handleCopy(voucher.id, voucher.code)}>
                    ...
                    <Form>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                ...
                                className="bg-transparent text-dark border-light fw-bold"
                            />
                        </Form.Group>
                        <Row>
                            <Col md={6}>
